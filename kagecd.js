function cdDrawCurveU(kage, polygons, x1, y1, sx1, sy1, sx2, sy2, x2, y2, ta1, ta2){
  ...
  if(kage.kShotai == kage.kMincho){ // mincho
    ...
    if(sx1 == sx2 && sy1 == sy2){ // Spline
      if(kage.kUseCurve){
        ...
        for(tt = 0; tt <= 1000; tt = tt + kage.kRate){
          ...
          if (((a1 == 7 || a1 == 27) || a1 == 27) && a2 == 0 && (sy2a < y2a)) {//L2RD-HARAI
          ...
          //copy to polygon structure
          poly.push(x - ia, y - ib);
          if (((a1 == 7 || a1 == 27) || a1 == 27) && a2 == 0 && (sy2a < y2a) && (y + ib > y2a)) {//L2RD-HARAI
            //poly2.push(x + ia, y2a);
          }else if (((a1 == 7 || a1 == 27) || a1 == 27) && a2 == 0 && (sy2a < y2a)) {//L2RD-HARAI
    ...
    if(a2 == 9 || (((a1 == 7 || a1 == 27) || a1 == 27) && a2 == 0 && (sy2a >= y2a))){ // Math.sinnyu & L2RD Harai ... no need for a2=9
      var type = (Math.atan2(Math.abs(y2 - sy2), Math.abs(x2 - sx2)) / Math.PI * 2 - 0.6);
      if(type > 0){
        type = type * 8;
      } else {
    ...
    opt3 = 0;
    if ((a1 == 0) && (x1 > x2) && (y1 < y2)) {opt3 = 1;}
    else if ((a1 == 0) && (x1 < x2) && (y1 > y2)) {opt3 = 2;}
    else if ((a1 == 0) && (x1 < x2) && (y1 < y2)) {opt3 = 1;}
    else if (((a1 % 100 == 22) || (a1 % 100 == 27)) && (y1 < y2)) {
        opt3 = 1;
        if((x1 != sx1) && (y1 != sy1)){
          ia = kWidth / 2 * ((x1 - sx1) / (y1 - sy1));
          ib = kWidth / 2;
        }
        else if(x1 == sx1){
          ia = kWidth / 2;
    ...
    for(tt = 0; tt <= 1000; tt = tt + kage.kRate){
      ...
      if(kage.kShotai == kage.kMincho){ //always false ?
        ...
        if(ix != 0 && iy != 0){
          ir = Math.atan(iy / ix * -1.0);
          ia = Math.sin(ir) * kWidth;
          ib = Math.cos(ir) * kWidth;
        }
        else if(ix == 0){
          if (iy < 0) {
            ia = -kWidth;
      ...
      if(x1 == x2){ //if TATE stroke, use y-axis
        ...
        if(a1 == 6){ //if it is KAGI's YOKO stroke, get bold
          ...
          if(a2 == 5){
            ...
            if(x1 < x2){
              poly.push(x2 + kMinWidthT, y2);
              poly.push(x2 + 2, y2 - kMinWidthT - kage.kWidth * (4 * (1 - opt1 / kage.kAdjustMageStep)));
              poly.push(x2, y2 - kMinWidthT - kage.kWidth * (4 * (1 - opt1 / kage.kAdjustMageStep)));
              poly.push(x2 - kMinWidthT, y2 - kMinWidthT);
            } else {
              poly.push(x2 - kMinWidthT, y2);
              poly.push(x2 - 2, y2 - kMinWidthT - kage.kWidth * (4 * (1 - opt1 / kage.kAdjustMageStep)));
